...
def mitre(country_from_input, target, limit, filename):
    ...
    def main(country_from_input, target_from_input, limit, filename):
        ...
        targets = {
            ...
            "Iran": ["APT39"],
            "Isreal": ["CopyKittens"],
            "Japan": ["BRONZE BUTLER", "APT16", "APT37", "BlackTech", "DragonOK", "Dust Storm"],
            "Jordan": ["CopyKittens"],
            "Kuwait": ["APT37"],
            "Laos": ["APT32"],
            "Middle East": ["OilRig", "APT29", "APT37", "BackdoorDiplomacy", "Bouncing Golf", "DarkHydrus", "Fox Kitten", "Gallmaker"],
            "Nepal": ["APT37"],
            ...
            "Defense": ["Machete", "APT19", "Ajax Security Team", "Andariel", "APT17", "APT28", "Axiom", "Confucius", "Deep Panda", "Dragonfly", "Elderwood", "Fox Kitten", "Gallmaker", "Gamaredon Group", "HAFNIUM"],
            "Education": ["SilverTerrier", "APT39", "DarkHydrus", "HAFNIUM"],
            ...
            "Government": ["Machete", "OilRig", "PLATINUM", "APT12", "APT18", "APT19", "Andariel", "APT28", "APT32", "Aquatic Panda", "Axiom", "BackdoorDiplomacy", "BRONZE BUTLER", "Confucius", "DarkHydrus", "Deep Panda", "Dragonfly", "Elderwood", "Fox Kitten", "Gallmaker", "Gorgon Group"],
            ...
            "Manufacturing": ["APT-C-36", "SilverTerrier", "APT18", "APT19", "Axiom", "BRONZE BUTLER", "Fox Kitten"],
            "Media": ["APT12", "APT32", "BlackOasis", "BlackTech", "Chimera"],
            "Mining": ["APT17"],
            "NGOs": ["Elderwood", "Gamaredon Group", "HAFNIUM"],
            "Non-Profits": ["Gamaredon Group"],
            "Petroleum": ["APT-C-36", "Fox Kitten", "HEXANE"],
            "Pharmaceutical": ["APT19", "FIN4", "Turla"],
            "Restaurant": ["FIN5", "FIN7", "FIN8"],
            "Retail": ["FIN6", "FIN7", "FIN8"],
            "Semiconductor": ["Chimera"],
            "Supply Chain": ["Elderwood"],
            "Technology": ["SilverTerrier", "Tropic Trooper", "APT12", "APT18", "APT17", "APT19", "APT29", "APT41", "Aquatic Panda", "Chimera", "Elderwood", "Fox Kitten"],
            "Telecommunications": ["Machete", "APT19", "APT29", "APT39", "APT41", "Aquatic Panda", "Deep Panda", "GALLIUM", "HEXANE"],
            ...
            "Think Tanks": ["APT29" , "BlackOasis", "HAFNIUM", "Kimsuky", "Patchwork" ]
